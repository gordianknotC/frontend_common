...
import {IBaseRouterGuard, IRouterInterceptor} from "~/base/guardianTypes";
import {TOptional} from "~/base/baseApiTypes";
import {RouteLocationObject, Router, RouteRecord} from "~/base/vueTypes";
...
export class BaseRouterInterceptor implements  IRouterInterceptor{
  ...
  pendingRoute: TOptional<RouteLocationObject>;
  ...
  get lastRoute(): TOptional<RouteRecord> {
